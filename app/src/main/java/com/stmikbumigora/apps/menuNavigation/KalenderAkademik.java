...
public class KalenderAkademik extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kalender_akademik);

        KalenderAkademik.this.setTitle("Information!");

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_satu_kalenderAkademik);
