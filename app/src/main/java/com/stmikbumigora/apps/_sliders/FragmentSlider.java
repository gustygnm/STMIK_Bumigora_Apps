package com.stmikbumigora.apps._sliders;
...
public class FragmentSlider extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Uri uri=Uri.parse("android.resource://com.stmikbumigora.apps/drawable/"+imageUrls);

        View view = inflater.inflate(R.layout.fragment_slider_item, container, false);
        ImageView img = (ImageView) view.findViewById(R.id.imgSlider);
